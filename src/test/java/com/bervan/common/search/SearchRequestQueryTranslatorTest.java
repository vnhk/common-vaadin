...
//         └── G3 (className != 'Main')
    ...
    @Test
    void translateQuery_4() {
        SearchRequest request = SearchRequestQueryTranslator.translateQuery("""
                applicationName = 'my-tools' & logLevel = 'ERROR' & (className = 'com.bervan.shstat.service.ProductService' | className = 'com.bervan.shstat.service.ActualProductService' | className = 'com.bervan.shstat.service.ProductStatsService')
                """, LogEntity.class);
