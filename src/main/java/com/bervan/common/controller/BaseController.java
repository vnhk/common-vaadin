...
public abstract class BaseController<T extends AbstractBaseEntity<ID> & BaseModel<ID> & PersistableData<ID>, ID extends Serializable> {
    ...
    protected BaseController(BaseService<ID, T> service, BervanDTOMapper mapper, EntityConfigValidator validator, String entityName) {
